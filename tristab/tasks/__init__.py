# https://github.com/BytedProtein/ByProt/blob/dd279dc85f76ee2c28c819b71bf3911b90159f0a/src/byprot/tasks/__init__.py
import copy
import glob
import importlib
import os
...
from tristab.utils.optim import get_optimizer
...
utils.import_modules(os.path.dirname(__file__), "tristab.tasks")
